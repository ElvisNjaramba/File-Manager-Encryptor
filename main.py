...
def load_settings():
    ...
    return {
        ...
        "monitor_delay_seconds": 600  # default 10 minutes
    }
...
# ---------------------------
# Watchdog event handler (uses settings['monitor_delay_seconds'])
# ---------------------------
...
# ---------------------------
# Startup registry helper (Windows)
# ---------------------------
